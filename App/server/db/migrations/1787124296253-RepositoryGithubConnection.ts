...
export class RepositoryGithubConnection1787124296253 implements MigrationInterface {
    name = 'RepositoryGithubConnection1787124296253'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "temporary_code_repositories"("id", "companyId", "name", "slug", "description", "gitUrl", "defaultBranch", "authMode", "httpsUsername", "encryptedToken", "encryptedSshKey", "committerName", "committerEmail", "lastSyncedAt", "lastSyncStatus", "lastSyncError", "createdById", "createdAt", "updatedAt", "origin", "kind") SELECT "id", "companyId", "name", "slug", "description", "gitUrl", "defaultBranch", "authMode", "httpsUsername", "encryptedToken", "encryptedSshKey", "committerName", "committerEmail", "lastSyncedAt", "lastSyncStatus", "lastSyncError", "createdById", "createdAt", "updatedAt", "origin", "kind" FROM "code_repositories"`);
