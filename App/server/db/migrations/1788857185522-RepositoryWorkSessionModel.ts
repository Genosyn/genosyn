...
export class RepositoryWorkSessionModel1788857185522 implements MigrationInterface {
    name = 'RepositoryWorkSessionModel1788857185522'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "repository_work_sessions"("id", "companyId", "repositoryId", "employeeId", "requestedByUserId", "instruction", "status", "branch", "baseCommit", "headCommit", "reply", "error", "filesChanged", "insertions", "deletions", "publishedBranch", "finishedAt", "createdAt", "updatedAt", "title", "turnCount", "pullRequestUrl", "pullRequestNumber", "archivedAt") SELECT "id", "companyId", "repositoryId", "employeeId", "requestedByUserId", "instruction", "status", "branch", "baseCommit", "headCommit", "reply", "error", "filesChanged", "insertions", "deletions", "publishedBranch", "finishedAt", "createdAt", "updatedAt", "title", "turnCount", "pullRequestUrl", "pullRequestNumber", "archivedAt" FROM "temporary_repository_work_sessions"`);
