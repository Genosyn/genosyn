...
const RECALL_CASES: Array<{ query: string; expect: string }> = [
  ...
  { query: "issue a quotation without emailing it", expect: "issue_estimate" },
  { query: "mark an estimate sent", expect: "issue_estimate" },
  { query: "email the customer their quotation", expect: "send_estimate" },
