...
export const TOOL_DOMAINS: Record<string, ToolDomain> = {
  ...
  revenue: {
    label: "revenue",
    blurb:
      "Follow-ups, accounts, contacts, deals, partnerships, sequences and signals. Needs a revenue grant.",
    tools: [
      "list_follow_ups",
      "create_follow_up",
      "update_follow_up",
...
export const TOOL_KEYWORDS: Record<string, string[]> = {
  ...
  list_follow_ups: ["sales queue", "overdue", "reminder", "next action", "due today"],
  ...
  list_revenue_imports: ["import history", "migration reports", "crm reconciliation"],
  get_revenue_import: ["import report", "migration reconciliation", "source row map"],
