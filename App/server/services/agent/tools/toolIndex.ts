...
export const TOOL_KEYWORDS: Record<string, string[]> = {
  ...
  list_finance_products: ["catalogue", "catalog", "product", "service", "pricing", "unit price", "tax"],
  ...
  open_repository_work_session_pull_request: ["pull request", "pr", "deliver", "push", "work session", "review"],
