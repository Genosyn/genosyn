...
export const TOOL_DOMAINS: Record<string, ToolDomain> = {
  ...
  improvement: {
    label: "improvement",
    blurb:
      "Find useful work and suggest improvements to your work, participating Routines, or new standing responsibilities.",
    tools: [
      "get_proactive_work",
      "get_own_work_review",
...
export const TOOL_KEYWORDS: Record<string, string[]> = {
  ...
  mail_block_sender: ["block spam", "junk email", "block sender", "stop spam"],
  mail_unsubscribe: ["unsubscribe newsletter", "stop marketing", "mailing list"],
  ...
  list_estimates: ["quote", "quotation", "prior quote", "estimate", "duplicate"],
  get_estimate: ["quote", "quotation", "line items", "estimate"],
  list_finance_products: [
    "catalogue",
    "catalog",
    "product",
  ...
  get_initiative: ["read initiative", "proposal feedback", "proposed routine brief"],
  get_proactive_work: [
  ...
  get_participating_routine: [
    "routine I helped with",
    "shared routine brief",
    "participating routine",
    "improve another employee routine",
  ],
  propose_revision: [
    "edit my soul",
    "improve skill",
