...
export const PRODUCT_USE_CASES: ProductUseCase[] = [
  ...
  },
  {
    ...
    productSlugs: ["code", "tasks", "workspace", "resources", "pipelines", "bases"],
    primaryProductSlug: "code",
  ...
  },
  {
    ...
    productSlugs: ["email", "customers", "resources", "workspace", "tasks", "notes", "code"],
  ...
  },
  {
    ...
    productSlugs: ["code", "resources", "pipelines", "ai-employees", "notes", "tasks"],
    primaryProductSlug: "code",
