  ...
  return (
    ...
    >
      <div className="flex items-start justify-between">
        ...
        <ArrowRight className="h-4 w-4 text-stone-300 transition group-hover:translate-x-0.5 group-hover:text-tide-600" />
      </div>
      ...
      <span className="mt-6 text-xs font-semibold text-tide-600">Explore product</span>
    </Link>
  );
}
