...
export function ProductPrototype({
  ...
  return (
    <section
      ...
      className={`prototype-shell pointer-events-none select-none overflow-hidden rounded-2xl border border-zinc-200 bg-white p-2 shadow-[0_30px_75px_-38px_rgba(15,23,42,0.48)] sm:p-3 ${className}`}
    >
      ...
      <div
        aria-hidden
        className="grid overflow-hidden rounded-xl border border-zinc-200 bg-paper-100 lg:grid-cols-[11.5rem_minmax(0,1fr)]"
      >
...
function PrototypeSidebar({
  ...
  return (
    <aside className="hidden min-w-0 border-r border-zinc-200 bg-paper-100 p-3 lg:flex lg:flex-col">
      <div className="text-[9px] font-bold uppercase tracking-label text-zinc-400">
        Employee on duty
      </div>
      <div className="mt-3 flex items-center gap-2.5 rounded-xl border border-zinc-200 bg-white p-2.5 shadow-card">
        <span
      ...
      <div className="mt-5 text-[9px] font-bold uppercase tracking-label text-zinc-400">
        Working set
      </div>
