    ...
    <div className="min-h-screen bg-white text-zinc-950">
      ...
      <main>
        <HeroSection>
          ...
          <ul className="mt-12 grid overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-card sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {product.features.map((feature) => {
                  ...
                  return (
                    <article
                      key={feature.title}
                      className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-card transition hover:-translate-y-0.5 hover:border-zinc-400 hover:shadow-lift"
                    >
                      <span
        ...
        <section className="on-night relative isolate overflow-hidden bg-night-950 text-zinc-400">
          ...
          <div className="mx-auto max-w-[88rem] px-5 py-20 sm:px-8 sm:py-24 lg:py-32">
            <div className="grid gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:items-start lg:gap-16">
              <div>
                <span className="text-[11px] font-semibold uppercase tracking-label text-zinc-400">
                  With AI Employees
                </span>
                ...
                <p className="mt-5 text-base leading-7 text-zinc-400">{product.employees.body}</p>
              </div>
                ...
                {product.employees.bullets.map((bullet, index) => (
                  ...
                  >
                    <div className="flex items-start gap-4">
                      <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-white/[0.08] text-xs font-semibold text-zinc-300">
                        {String(index + 1).padStart(2, "0")}
                      </span>
                      <div>
                        <h3 className="text-sm font-semibold text-white">{bullet.title}</h3>
                        <p className="mt-2 text-sm leading-6 text-zinc-400">{bullet.body}</p>
                      </div>
                    </div>
                  </article>
                ))}
          ...
          {related.map((product) => {
            ...
            return (
              <Link
                ...
                className="group rounded-2xl border border-zinc-200 bg-white p-4 shadow-card transition hover:-translate-y-0.5 hover:border-zinc-400 hover:shadow-lift"
              >
                <div className="flex items-center gap-3">
                  <span
