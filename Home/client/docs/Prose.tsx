...
export function Pre({
  ...
  return (
    <div className="mt-6 overflow-hidden rounded-xl border border-night-700 bg-night-950 shadow-card">
      {lang && (
        <div className="flex items-center justify-between border-b border-white/10 px-4 py-2 font-mono text-[10.5px] font-semibold uppercase tracking-label text-zinc-400">
          <span>{lang}</span>
        </div>
      )}
