  ...
  return (
    <>
      ...
      <div className="mt-12">
        <Link
          href="/docs/install"
          className="inline-flex items-center gap-2 rounded-xl bg-night-950 px-5 py-2.5 text-sm font-semibold text-white shadow-card transition hover:bg-bloom-600"
        >
          Install Genosyn
