    ...
    <>
      ...
      <UL>
        <LI>
          ...
          timeouts and nothing graded{" "}
          <DocLink to="/docs/routines#outcome-check">off goal</DocLink>.
        </LI>
        <LI>
      ...
      <P>
        ...
        <Code>off goal</Code>, revokes <Strong>every</Strong> active waiver the employee holds and
        re-arms the gates on the spot. The employee&apos;s journal records what happened and why,
