      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex flex-col gap-10 lg:flex-row lg:gap-12">
          <aside
            ...
            className={`fixed inset-y-0 left-0 z-40 w-72 transform overflow-y-auto border-r border-zinc-200 bg-paper-50 px-6 pb-10 pt-20 transition-transform lg:sticky lg:top-16 lg:z-auto lg:h-[calc(100vh-4rem)] lg:w-60 lg:flex-shrink-0 lg:translate-x-0 lg:border-r-0 lg:px-0 lg:pb-12 lg:pt-10 ${
