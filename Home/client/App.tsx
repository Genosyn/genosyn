  ...
  return (
    <div className="min-h-screen bg-paper-100 text-stone-800">
      ...
      <main className="mx-auto flex max-w-7xl flex-col items-center px-6 py-32 text-center">
        <div className="text-xs font-semibold text-ink-600">404</div>
        ...
        <Link
          href="/products"
          className="mt-8 inline-flex items-center gap-2 rounded-xl bg-ink-500 px-5 py-3.5 text-sm font-semibold text-white shadow-card transition hover:bg-ink-600"
        >
          Browse all products
