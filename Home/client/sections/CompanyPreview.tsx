        ...
        {NAV_ITEMS.map((item) => (
          <div
            ...
            className={`flex items-center gap-2.5 rounded-lg px-2.5 py-2 text-[11px] font-medium ${
              item.active
                ? "bg-bloom-100 text-bloom-700 ring-1 ring-inset ring-bloom-200"
                : "text-stone-600"
            }`}
          >
          ...
          <div key={item.name} className="flex items-center gap-2">
            ...
            <span
              className={`ml-auto h-1.5 w-1.5 rounded-full ${
                index === 2 ? "preview-live bg-bloom-500" : "bg-emerald-500"
              }`}
            />
          </div>
        ))}
  ...
  return (
    <div className="min-w-0 bg-paper-100 px-4 py-5 sm:px-6 sm:py-6">
      ...
      <div className="mt-5 grid grid-cols-2 gap-2.5 xl:grid-cols-4">
        ...
        <Stat icon={Users} value="7" label="AI Employees" accent="bloom" />
      </div>
      ...
      <div className="mt-3 grid gap-3 xl:grid-cols-[1.08fr_0.92fr]">
        <div className="overflow-hidden rounded-xl border border-stone-900/[0.08] bg-white shadow-card">
          <div className="flex items-center justify-between border-b border-stone-900/[0.06] px-4 py-3">
            ...
            <span className="text-[9px] font-semibold text-bloom-600">View all Runs</span>
          </div>
        ...
        <div className="overflow-hidden rounded-xl border border-stone-900/[0.08] bg-white shadow-card">
          ...
          <div className="mx-3 mb-3 rounded-lg border border-bloom-200 bg-bloom-50 px-3 py-2.5">
            <div className="flex items-center gap-2 text-[10px] font-semibold text-bloom-700">
...
const STAT_ACCENTS = {
  ...
  bloom: "bg-bloom-100 text-bloom-700 ring-bloom-200",
} as const;
