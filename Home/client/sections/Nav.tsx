    ...
    >
      <div className="mx-auto flex h-16 max-w-[88rem] items-center justify-between gap-6 px-5 sm:px-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            href="/#quickstart"
            className="group hidden items-center gap-1.5 rounded-xl bg-tide-500 px-4 py-2 text-sm font-semibold text-white shadow-card transition duration-200 hover:bg-tide-600 sm:inline-flex"
          >
            Install
            <ArrowRight
              aria-hidden
        ...
        <div className="border-t border-stone-900/[0.08] bg-paper-50/95 backdrop-blur-xl lg:hidden">
          ...
          >
            ...
            <a
              href="/#quickstart"
              onClick={() => setOpen(false)}
              className="mt-1 inline-flex items-center justify-center rounded-xl bg-tide-500 px-3 py-2.5 text-sm font-semibold text-white shadow-card"
            >
              Install Genosyn
            </a>
          </nav>
