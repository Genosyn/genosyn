...
function DeploymentRow({
  ...
  return (
    <article className="rounded-2xl border border-stone-900/[0.08] bg-white p-5 shadow-card transition hover:-translate-y-0.5 hover:border-tide-300 hover:shadow-lift">
        ...
        <div className="on-night relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-stone-900 to-night-850 px-6 py-14 text-center shadow-raise sm:px-12 sm:py-20">
          ...
          <div className="relative mx-auto max-w-2xl">
            ...
            <p className="mt-6 text-xs text-white/60">
              ...
              <Link href="/pricing" className="font-semibold text-white underline underline-offset-2 hover:text-tide-200">
                See pricing
              </Link>
            </p>
          </div>
