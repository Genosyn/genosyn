            ...
            <ul className="mt-5 space-y-3 text-sm">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="text-stone-600 transition hover:text-ink-600"
                >
                  GitHub
                </a>
              </li>
              ...
              <li>
                <a href="/install.sh" className="text-stone-600 transition hover:text-ink-600">
                  install.sh
                </a>
              </li>
            </ul>
    ...
    <nav aria-label={title}>
      ...
      <ul className="mt-5 space-y-3 text-sm">
        {links.map(([label, href]) => (
          <li key={href}>
            <Link href={href} className="text-stone-600 transition hover:text-ink-600">
              {label}
            </Link>
          </li>
        ))}
